...
class Node:
    ...
    def connect(self, node_classess: dict = None):
        """Create relationship between two AWS resource nodes

        Args:
            node_classess (_type_, optional): _description_. Defaults to None.
        """
...
class AWS_EC2_RouteTable(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::VPC': 'is_contained_in_vpc',
                 'AWS::EC2::Subnet': 'contains_subnet'}
        return value
...
class AWS_EC2_NetworkInterface(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::SecurityGroup': 'is_associated_with_securitygroup',
                 'AWS::EC2::Subnet': 'is_contained_in_subnet', 'AWS::EC2::VPC': 'is_contained_in_vpc'}
        return value
...
class AWS_EC2_NetworkAcl(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::Subnet': 'is_attached_to_subnet',
                 'AWS::EC2::VPC': 'is_contained_in_vpc'}
        return value
...
class AWS_EC2_SecurityGroup(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::NetworkInterface': 'is_associated_with_networkinterface',
                 'AWS::EC2::VPC': 'is_contained_in_vpc'}
        return value
...
class AWS_EC2_Subnet(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::NetworkAcl': 'is_attached_to_networkacl',
                 'AWS::EC2::NetworkInterface': 'contains_networkinterface',
                 'AWS::EC2::RouteTable': 'is_contained_in_routetable',
                 'AWS::EC2::VPC': 'is_contained_in_vpc'}
        return value
...
class AWS_EC2_VPC(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::EC2::NetworkAcl': 'contains_networkacl',
                 'AWS::EC2::NetworkInterface': 'contains_networkinterface',
                 'AWS::EC2::InternetGateway': 'is_attached_to_internetgateway',
                 'AWS::EC2::RouteTable': 'contains_routetable',
                 'AWS::EC2::SecurityGroup': 'contains_securitygroup',
                 'AWS::EC2::Subnet': 'contains_subnet'}
        return value
...
class AWS_Redshift_Cluster(BaseAWSResource, Node):
    ...
    @validator('relationship_types', pre=True, always=True)
    def set_relationship_types(cls, value):
        value = {'AWS::Redshift::ClusterParameterGroup': 'is_associated_with_clusterparametergroup',
                 'AWS::Redshift::ClusterSubnetGroup': 'is_associated_with_clustersubnetgroup',
                 'AWS::EC2::SecurityGroup': 'is_associated_with_securitygroup'}
        return value
